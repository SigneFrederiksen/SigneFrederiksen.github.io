...
var _content = __webpack_require__(334);

var _content2 = _interopRequireDefault(_content);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mycontent = new _content2.default();
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Imports data from the files into this file.
...
var _temp = __webpack_require__(336);
    ...
    _createClass(MyContent, [{
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var bitCoinData, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, currency, data, listElement;
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _data2.default.getBitcoinData();
                            ...
                            case 2:
                                ...
                                for (_iterator = Object.keys(bitCoinData.rates)[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                    currency = _step.value;
                                    data = bitCoinData.rates[currency];
                                    //console.log(currency);

                                    listElement = _temp2.default.toDom('\n                <div class="bitcoin-item">\n                    <h4>"' + currency + '": <span class="curl">&#123;</span></h4>\n                    <div class="bitcoin-content">\n                        <p>"rate": ' + data.rate + '</p>\n                        <p>"name": ' + data.name + '</p>\n                    </div>\n                </div>\n                <h4><span class="curl">&#125;,</span></h4>\n            ');
            ...
            function listBitcoinData() {
                return _ref.apply(this, arguments);
            }

            return listBitcoinData;
        }()
    }, {
        key: 'updateData',
        value: function updateData() {
            this.updateDataElement.addEventListener("click", function () {
                //alert("Success");
...
var Data = function () {
    ...
    _createClass(Data, null, [{
        ...
        // Defines a method for fetching data from a bitcoin API.
        value: function getBitcoinData() {

            return fetch('https://apiv2.bitcoinaverage.com/constants/exchangerates/local').then(function (response) {
...
var ContentTemplate = function () {
    ...
    _createClass(ContentTemplate, null, [{
        key: 'toDom',
        value: function toDom(strHTML) {
